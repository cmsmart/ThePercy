...
const renderLegend = () => {
  ...
  <p style={{ padding: "0.3rem 1.2rem", textAnchor: 'middle', margin: 0, fontSize: '0.8em', textAlign: 'center',
    fontWeight: 'bold'}}>Legend</p>
  <p style={{ backgroundColor: "#b5b991", padding: "0.5rem 1.2rem", margin: "0.1rem", textAnchor: 'middle', fontSize: '0.8em', textAlign: 'center'}}> Rookie </p>
  <p style={{ textAlign: 'center', color: '#fff', backgroundColor: "#3d5941", fontSize: '0.8em', padding: "0.5rem 1.2rem", textAnchor: 'middle', margin: "0.1rem" }}> Veteran</p>
  </div>;
}
...
class ProgressBarChart extends Component{
  ...
  return (
    <div className="area-chart-wrapper" style={{ width: '95%', height: "500px", backgroundColor: "#f8f8f8", border: "1px solid black", margin: "10px" }} display= "inline-block">
      <ResponsiveContainer>
        <LineChart width={300} height={300} margin={{top: 50, right: 30, left: 50, bottom: 50}}>
            ...
            <YAxis type="category" dataKey="bib">
              <Label value="Name" angle={-90} offset={-35} position="insideLeft" style={{ textAnchor: 'middle' }} content={renderLabel}/>
             </YAxis>
